...
echo ""
echo "1. MuseScore piano collection used in the paper"
echo "   - Paper protocol: 192,788 pieces; 80%/10%/10% train/validation/test"
echo "   - Prepare one complete, deduplicated song per NPZ before splitting."
...
echo ""
echo "=== Notes ==="
echo "- Public MLM defaults: 80%/10%/10%, seed 42; validation selects best_model."
echo "- Keep the held-out test partition for final evaluation only."
