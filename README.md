...
repository. Experimental outputs are generated locally and ignored by Git.
...
of this release and are skipped with a notice. Refer to the paper for the
reported baseline timings.
...
This repository distributes implementation code and documentation, without
pre-computed experimental results or JSON files. Run evaluations locally
before using the statistical analysis and table-generation scripts.
Generated results and JSON files are ignored by Git.

## Hardware Requirements

- **Training**: 2x GPU with 24GB VRAM each (paper used this setup)
- **Inference**: Single GPU (37-655 ms per sample)
- **Statistical analysis of locally generated metrics**: CPU only
