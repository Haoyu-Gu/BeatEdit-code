"""
Music BERT MLM pretraining script.
...
def train():
    parser = argparse.ArgumentParser(description='Music BERT MLM Pre-training')
    ...
    if accelerator.is_main_process:
        ...
        print("=" * 60)
        print("Music BERT MLM Pre-training")
        print("=" * 60)
        print(f"Encoding: no_pair / absolute position (vocab={token_config.vocab_size})")
