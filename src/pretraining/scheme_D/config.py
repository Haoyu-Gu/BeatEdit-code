"""
Music BERT 配置 (absolute_bundled 编码方案 - Scheme D)

基于绝对位置捆绑编码 (absolute bundled encoding, vocab=7144)
在原始音乐词表基础上增加 [MASK] token 用于 MLM 预训练

bundled_token = absolute_pitch × 81 + patch_value, 范围 0-7127
"""
...
class MusicTokenConfig:
    """音乐 token 编码配置 (absolute_bundled 方案)"""
    # Patch 编码参数
    patch_h: int = 1
    patch_w: int = 4
