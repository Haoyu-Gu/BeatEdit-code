"""
FELIX-Music Perturbation System (Scheme B: no_pair_related).
...
- Empty beats: tokens=[EMPTY_MARKER], not tokens=[]
- encode_beat returns [EMPTY_MARKER] for empty, [pos,val,...,END_MARKER] for non-empty
...
from configs.config import (
    MAX_PITCH, PATTERN_NUM, EMPTY_MARKER,
)
