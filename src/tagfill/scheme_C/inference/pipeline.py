...
from configs.config import (
    LABEL_KEEP, LABEL_REPLACE, MASK_TOKEN, PAD_TOKEN,
    EMPTY_MARKER, SPLIT_0, SPLIT_1, BAR_TOKEN,
    PATTERN_NUM, is_bundled_token,
...
class FELIXPipeline:
    ...
    def generate_inpainting(
        ...
        # Mask accompaniment beats in range
        ...
        # Run Inserter directly (skip Tagger)
        if inserter_steps > 1:
        ...
        # Optional harmony post-processing
        if harmony_weight > 0.0:
