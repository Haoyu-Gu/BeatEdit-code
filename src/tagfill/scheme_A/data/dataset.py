"""
FELIX-Music Datasets and Collators (Scheme A: no_pair).
...
from configs.config import (
    TRACK0_START, TRACK1_START, BAR_TOKEN, EOS_TOKEN, BOS_TOKEN, PAD_TOKEN,
...
class FELIXTaggerDataset(FELIXBaseDataset):
    ...
    def _fallback_item(self, idx):
        try:
            ...
            token_sequence = [BOS_TOKEN, TIME_SIG_OFFSET, BPM_OFFSET, BAR_TOKEN, TRACK0_START, 0, TRACK1_START, 0, EOS_TOKEN]
