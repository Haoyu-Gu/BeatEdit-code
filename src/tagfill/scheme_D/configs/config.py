"""
FELIX-Music Configuration (Scheme D: absolute_bundled)

Token constants (from absolute_bundled encoding), FELIX token-level label system,
and model/training hyperparameters.

Encoding scheme: absolute_bundled encoding (vocab=7145 with MASK)
  bundled = abs_pitch × 81 + patch_value (absolute position, no cumulation)
...
# ==================== Token Constants (absolute_bundled) ====================

# Bundled token: absolute_pitch × 81 + patch_value
# Range: 0-7127
BUNDLED_TOKEN_MIN = 0
