...
class PianoDataset(Dataset):
    ...
    def _process_measure_with_beat_interleaving(
        ...
        for beat_idx in range(num_beats):
            ...
            compressed_tokens_0 = self.tokenizer.compress_tokens(tokens_0, track_marker_id=self.track0_start_id)
            ...
            compressed_tokens_1 = self.tokenizer.compress_tokens(tokens_1, track_marker_id=self.track1_start_id)
