"""
Perturbation functions for GECToR training data (absolute_bundled encoding - Scheme D).

Core principle: perturb in absolute pitch space, then re-encode to bundled tokens.
This is encoding-agnostic since perturbations operate on (abs_pitch, val) tuples.
...
def perturb_sequence(token_sequence, p_pitch=0.10, p_rhythm=0.05,
    ...
    for beat in beats_info['beats']:
        ...
        # Skip empty beats: they have no SPLIT marker info,
