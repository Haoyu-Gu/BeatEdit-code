"""
Music GECToR Evaluation Script
...
Usage:
    python evaluate.py --checkpoint checkpoints/gector/best_model \
...
def print_results(results):
    ...
    print("\n" + "=" * 60)
    print("Music GECToR Evaluation Results")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description='Music GECToR Evaluation')
