"""
Music GECToR Inference Pipeline (with_pair encoding)
...
Usage:
    python inference.py --checkpoint checkpoints/gector_with_pair/best_model \
...
def inference_single(model, input_tokens, device='cpu',
    ...
    Args:
        ...
        device: torch device
        max_iterations: maximum correction rounds (default 2 for with_pair)
...
def main():
    parser = argparse.ArgumentParser(description='Music GECToR Inference (with_pair)')
