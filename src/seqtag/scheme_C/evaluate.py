"""
Music GECToR Evaluation Script (with_pair encoding)
...
Usage:
    python evaluate.py --checkpoint checkpoints/gector_with_pair/best_model \
...
def print_results(results):
    ...
    print("\n" + "=" * 60)
    print("Music GECToR Evaluation Results (with_pair)")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description='Music GECToR Evaluation (with_pair)')
