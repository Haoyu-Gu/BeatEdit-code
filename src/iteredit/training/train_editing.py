"""
Training script for Levenshtein Transformer Editing.

Trains LevT for accompaniment editing (T3) using perturbation-based data.
Supports all 4 encoding schemes; recommended to start from the best vanilla
inpainting checkpoint for the target scheme.
...
Usage:
    ...
    CUDA_VISIBLE_DEVICES=0,1 \
        ...
        --lr 1e-4 --batch_size 32 --epochs 30 --gradient_accumulation 2 \
        --output_dir LevT_training_results/editing_v2/scheme_a
"""
...
from data.dataset_editing import (
    LevTEditingDataset, LevTEditingCollator, BucketBatchSampler,
    get_file_lists, load_lengths_cache, SCHEME_TOKENS, DATA_DIR,
)
...
def main():
    ...
    if accelerator.is_main_process:
        print(f"=== LevT Editing Training (Scheme {scheme}) ===")
